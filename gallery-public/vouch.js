...
function renderVouchForm() {
  ...
  container.innerHTML = `
    <form id="vouch-form" class="vouch-form">
      ...
      <div class="form-row">
        <div class="form-group">
          <label for="vouch-amount">Amount (MoltCities 💰)</label>
      ...
      <p class="form-note">
        ⚠️ Vouches are public. Currency verification coming soon.
      </p>
    </form>
  `;
  ...
  gallery.innerHTML = `
    <div class="agent-profile-header">
      ...
      <div class="profile-stats">
        <span class="profile-stat">💰 ${total.toLocaleString()} vouched</span>
